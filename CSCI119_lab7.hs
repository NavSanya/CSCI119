...
*Main> proper (Union' [Let' 'a', Let' 'b'])
True
*Main> proper (Union' [Let' 'a', One])
False
*Main> proper (Union' [One])
False

*Main> proper (Cat' [Let' 'a', Let' 'b'])
True
...
*Main> proper (Star' (Let' 'a'))
False
-}

--testing FSMs
even_as :: FSM Int
even_as = ([0,1], 0, [0], d) where
    d q a = if a == 'a' then (q+1) `mod` 2 else q

odd_as :: FSM Int
odd_as = ([0,1], 0, [1], d) where
    d q a = if a == 'a' then (q+1) `mod` 2 else q

even_bs :: FSM Int
even_bs = ([0,1], 0, [0], d) where
...
{-
*Main> toSPLE even_as
([[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']],[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']]],[One,Zero])
*Main> toSPLE odd_as
([[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']],[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']]],[Zero,One])
*Main> toSPLE even_bs
([[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']],[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']]],[One,Zero])
*Main> toSPLE odd_bs
([[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']],[Union' [Let' 'a',Let' 'b'],Union' [Let' 'a',Let' 'b']]],[Zero,One])
...
*Main> conv even_as
Star' (Union' [Let' 'a',Let' 'b'])
*Main> conv odd_as
Union' [Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'a',Star' (Union' [Let' 'a',Let' 'b'])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'b',Star' (Union' [Let' 'a',Let' 'b'])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'b',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'b',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'a',Star' (Union' [Let' 'a',Let' 'b'])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'b',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'b',Star' (Union' [Let' 'a',Let' 'b'])]]
*Main> conv even_bs
Star' (Union' [Let' 'a',Let' 'b'])
*Main> conv odd_bs
Union' [Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'a',Star' (Union' [Let' 'a',Let' 'b'])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'b',Star' (Union' [Let' 'a',Let' 'b'])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'b',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'b',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'a',Star' (Union' [Let' 'a',Let' 'b'])],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'b',Star' (Union' [Let' 'a',Let' 'b',Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'a',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Let' 'b',Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]),Let' 'b',Star' (Union' [Let' 'a',Let' 'b'])]]
