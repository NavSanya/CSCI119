...
{-
-- inters oddbs and evenas
*Main> (qs, s, fs, d) = inters oddbs evenas
*Main> qs
[(0,0),(0,1),(1,0),(1,1)]
*Main> s
(0,0)
...
[((0,0),'a',(0,1)),((0,0),'b',(1,0)),((0,1),'a',(0,0)),((0,1),'b',(1,1)),
((1,0),'a',(1,1)),((1,0),'b',(0,0)),((1,1),'a',(1,0)),((1,1),'b',(0,1))]


-- Reg evenas
*Main> (qs, s, fs, d) = evenas
*Main> qs
[0,1]
*Main> s
0
...
*Main> homo_dir k Empty
Empty
*Main> homo_dir k (Let 'a')
Let 'b'
*Main> homo_dir k (Union (Let 'a') (Let 'b'))
Union (Let 'b') (Let 'a')
*Main> homo_dir k (Cat (Let 'a') (Let 'b'))
Cat (Let 'b') (Let 'a')
*Main> homo_dir k (Star (Let 'a'))
Star (Let 'b')
...
-- homo_inv evenas
*Main> (qs, s, fs, d) = homo_inv k evenas
*Main> qs
[0,1]
*Main> s
0
...
--right quotient with "a" makes evenas into oddas 
*Main> accept1 (quot_right ["a"] evenas) "a"
True
*Main> accept1 (quot_right ["a"] evenas) "aa"
False
*Main> accept1 (quot_right ["a"] evenas) "aaa"
True
...
False
*Main> accept1 oddbs "ab"
True

*Main> nacc (fsm_to_nfsm oddbs) "b"
True
*Main> nacc (fsm_to_nfsm oddbs) "bb"
False
*Main> nacc (fsm_to_nfsm oddbs) "a"
False
*Main> nacc (fsm_to_nfsm oddbs) "ab"
True

2. m and nfsm_to_fsm m accept the same strings

*Main> nacc n_even_bs "b"
False
*Main> nacc n_even_bs "bb"
True
*Main> nacc n_even_bs "a"
True
*Main> nacc n_even_bs "ab"
False

*Main> accept1 (nfsm_to_fsm n_even_bs) "b"
False
*Main> accept1 (nfsm_to_fsm n_even_bs) "bb"
True
*Main> accept1 (nfsm_to_fsm n_even_bs) "a"
True
*Main> accept1 (nfsm_to_fsm n_even_bs) "ab"
False

3. m and efsm_to_fsm m accept the same strings

*Main> eacc string_ab "ab"
True
*Main> eacc string_ab "aab"
False
*Main> eacc string_ab "bab"
False

*Main> accept1 (efsm_to_fsm string_ab) "ab"
True
*Main> accept1 (efsm_to_fsm string_ab) "aab"
False
*Main> accept1 (efsm_to_fsm string_ab) "bab"
False
